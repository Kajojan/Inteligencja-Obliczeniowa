...
[train_set, test_set] = train_test_split(iris.values, train_size=0.7, random_state=278892)
# print(test_labels)
...
clf = MLPClassifier(solver='lbfgs', alpha=1e-5, hidden_layer_sizes=(3,3), random_state=278892)
