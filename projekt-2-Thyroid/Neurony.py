...
history= model.fit(train_data, train_classes, epochs=30, batch_size=16, validation_data=(test_data, test_classes))
...
history2 = model2.fit(train_data2, train_classes2, epochs=30, batch_size=16, validation_data=(test_data2, test_classes2))
